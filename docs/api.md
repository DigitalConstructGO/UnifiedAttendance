...
This doc covers _what_ each endpoint accepts and returns. For _why_ — the business rules,
...
_protocol_ endpoints — see [Device protocol](#device-protocol-iclock) below).
